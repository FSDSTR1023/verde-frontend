...
import { AppBar, Badge, Box, Button, Icon, ImageList, ImageListItem, Toolbar } from "@mui/material";
...
export const ClientGallery = () => {
  ...
  return (
    <>
      ...
      {
        // Aquí va la barra de elección para descarga de fotos
        // TODO: que cada <ImageList/ > sea un componente
      }
        ...
        <AppBar position="static" color="transparent" elevation={0}>
          <Toolbar>
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
              ...
              <p style={{ marginLeft: '.3em', marginRight: '1em' }}>5</p>
            </Box>
            <Box sx={{ flexGrow: 1 }} />
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
              <Icon size="small">
