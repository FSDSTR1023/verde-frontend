    ...
    <div>
      ...
      <ActionBarClient
        ...
        right={[
          ...
          {
            id: 'addPic',
            IconOrButton: <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
          ...
          {
            id: 'deletePic',
            IconOrButton: <svg className="ml-10" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
