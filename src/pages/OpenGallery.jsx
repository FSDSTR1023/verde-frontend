        ...
        <div className="flex flex-col text-right items-end h-full  p-4">
          <div className="flex items-center gap-1 justify-end text-lg Tenor-Sans tracking-wide">
            ...
            <Fab
              ...
              toShow={
                <EditGallery
                  prevTitle={gal?.title?.toUpperCase()}
                  prevMinPics={gal?.minPics}
                  prevTotalPrice={gal?.totalPrice}
          ...
          <div
            onClick={sendMail}
            className="Be-Vietnam-Pro  font-light tracking-widest border hover:cursor-pointer rounded-full py-2 px-4 shadow text-center mt-2"
          >
            ENVIAR
          </div>
        </div>
