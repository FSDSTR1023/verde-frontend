    ...
    <div>
      <div className="flex justify-between p-10 items-center flex-wrap">
        <a href={gal?.photos ? modifyPhoto(gal?.photos[0], false, 'auto', 'auto:best') : '#'} target="_blank" rel="noopener noreferrer">
          ...
          <img className="max-w-md w-full" src={gal?.photos?.length > 0 ? modifyPhoto(gal?.photos[0]) : '/blanco.png'} />
      ...
      <ActionBarClient
        ...
        right={[
          ...
          {
            id: 'addPic',
            IconOrButton: <Fab icon={<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
              <path d="M7.49704 0C7.82246 0 8.09149 0.226558 8.13408 0.520646L8.13999 0.602405L8.14102 6.42693H14.3572C14.7122 6.42693 15 6.6967 15 7.02946C15 7.3345 14.7581 7.58659 14.4445 7.62652L14.3572 7.63198H8.14102L8.14274 13.4557C8.14282 13.7884 7.85511 14.0584 7.50013 14.0584C7.17471 14.0584 6.90569 13.8318 6.86309 13.5377L6.85718 13.4559L6.85546 7.63198H0.64278C0.287777 7.63198 0 7.36221 0 7.02946C0 6.72442 0.241814 6.47232 0.555559 6.4324L0.64278 6.42693H6.85546L6.85443 0.602646C6.85435 0.269883 7.14206 0 7.49704 0Z" fill="#7C7C7C" />
            </svg>}
          ...
          {
            id: 'deletePic',
            IconOrButton: <svg onClick={deleteElem} className="ml-10 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
